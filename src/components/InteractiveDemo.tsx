    ...
    <section className="py-20 px-4 bg-gradient-to-b from-background to-gray-50">
      <div className="container max-w-7xl mx-auto">
            ...
            return (
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs opacity-70 hidden sm:block">{demo.description}</div>
                </div>
              </Button>
            );
          })}
        ...
        <div className="text-center mt-16 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          <div className="bg-gradient-to-r from-[hsl(var(--atd-primary))]/10 to-[hsl(var(--atd-accent))]/10 rounded-2xl p-8 border border-blue-100">
